...
\lstset{language=Java,
  ...
  breaklines=true, tabsize=2, keywordstyle=\color{blue},backgroundcolor=\color{lightgray},commentstyle=\color{gray}, labelstyle=\tiny, labelstep=5, firstlabel=1, labelsep=5pt}
\lstset{                       
